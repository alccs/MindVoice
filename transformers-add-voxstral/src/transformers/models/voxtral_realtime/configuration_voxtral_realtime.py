...
class VoxtralRealtimeConfig(PreTrainedConfig):
    ...
    def __init__(
        ...
        audio_config=None,
        text_config=None,
        encoder_args=None,  # Alias for audio_config for backward compatibility
        decoder=None,  # Alias for text_config for backward compatibility
        ...
        **kwargs,
        ...
        # Handle backward compatibility: encoder_args -> audio_config, decoder -> text_config
        if encoder_args is not None and audio_config is None:
            audio_config = encoder_args
        if decoder is not None and text_config is None:
            text_config = decoder
